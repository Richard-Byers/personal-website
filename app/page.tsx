...
export default function Home() {
  ...
  const revealProps = (direction: string) => ({
    custom: direction,
  ...
  return (
    <>
      ...
      <main className="container mx-auto py-10 px-4 pt-20">
        <motion.div {...revealProps('left')} id="about" className="mb-6">
          <ProfileCard
            name="Richard Byers"
        ...
        <motion.div {...revealProps('right')} id="skills" className="mb-6">
          <SkillsCard
            title="Skills"
            webDev={[
        ...
        <motion.div {...revealProps('left')} id="experience" className="mb-6">
          <TimelineCard
            title="Experience"
            info={[
              {
        ...
        <motion.div {...revealProps('right')} id="education" className="mb-6">
          <TimelineCard
            title="Education"
            info={[
              {
        ...
        <motion.div {...revealProps('up')} id="projects" className="mb-6">
          <TimelineCard
            title="Projects"
            info={[
              {
